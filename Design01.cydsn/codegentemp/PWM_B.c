...
void PWM_B_Stop(void) 
{
    ...
    *******************************************************************************/
    ...
    {
        CY_SET_REG16(PWM_B_COUNTER_LSB_PTR, counter);
    }
    ...
    *******************************************************************************/
    uint16 PWM_B_ReadCounter(void) 
    {
        ...
        return (CY_GET_REG16(PWM_B_CAPTURE_LSB_PTR));
    }
...
void PWM_B_WritePeriod(uint16 period) 
{
    ...
    #else
        CY_SET_REG16(PWM_B_PERIOD_LSB_PTR, period);
    #endif /* (PWM_B_UsingFixedFunction) */
}
    ...
    *******************************************************************************/
                                       ...
                                       
    {
        ...
        #else
            CY_SET_REG16(PWM_B_COMPARE1_LSB_PTR, compare);
        #endif /* (PWM_B_UsingFixedFunction) */
            ...
            #else
                CY_SET_REG16(PWM_B_COMPARE2_LSB_PTR, (compare + 1u));
            #endif /* (PWM_B_UsingFixedFunction) */
    ...
    *******************************************************************************/
    ...
    {
        #if(PWM_B_UsingFixedFunction)
            return ((uint16)CY_GET_REG16(PWM_B_COMPARE1_LSB_PTR));
        #else
            return (CY_GET_REG16(PWM_B_COMPARE1_LSB_PTR));
        #endif /* (PWM_B_UsingFixedFunction) */
    }
    ...
    *******************************************************************************/
    ...
    {
        return (CY_GET_REG16(PWM_B_COMPARE2_LSB_PTR));
    }
...
{
    #if(PWM_B_UsingFixedFunction)
        return ((uint16)CY_GET_REG16(PWM_B_PERIOD_LSB_PTR));
    #else
        return (CY_GET_REG16(PWM_B_PERIOD_LSB_PTR));
    #endif /* (PWM_B_UsingFixedFunction) */
}
