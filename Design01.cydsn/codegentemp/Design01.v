...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=true, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=2, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=0, CompareValue2=63, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=1, DeadBand2_4=1, DeadBand256=0, DeadBandUsed=1, DeadTime=2, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=255, PWMMode=3, PWMModeCenterAligned=1, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=false, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=false, TermVisibility_kill=false, TermVisibility_ph1=true, TermVisibility_ph2=true, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=true, UDB8=false, UseControl=true, UseInterrupt=false, UseStatus=false, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=PWM_v3_30, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_C, CY_INSTANCE_SHORT_NAME=PWM_C, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 SP2, INSTANCE_NAME=PWM_C, )
module PWM_v3_30_1 (
    pwm2,
    tc,
    clock,
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=true, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=2, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=0, CompareValue2=63, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=1, DeadBand2_4=1, DeadBand256=0, DeadBandUsed=1, DeadTime=2, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=255, PWMMode=3, PWMModeCenterAligned=1, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=false, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=false, TermVisibility_kill=false, TermVisibility_ph1=true, TermVisibility_ph2=true, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=true, UDB8=false, UseControl=true, UseInterrupt=false, UseStatus=false, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=PWM_v3_30, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_B, CY_INSTANCE_SHORT_NAME=PWM_B, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 SP2, INSTANCE_NAME=PWM_B, )
module PWM_v3_30_2 (
    pwm2,
    tc,
    clock,
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=true, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=2, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=0, CompareValue2=63, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=1, DeadBand2_4=1, DeadBand256=0, DeadBandUsed=1, DeadTime=2, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=true, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=1, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=255, PWMMode=3, PWMModeCenterAligned=1, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=true, TermVisibility_ph2=true, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=true, UDB8=false, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=PWM_v3_30, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_A, CY_INSTANCE_SHORT_NAME=PWM_A, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 SP2, INSTANCE_NAME=PWM_A, )
module PWM_v3_30_3 (
    pwm2,
    tc,
    clock,
...
// Counter_v3_0(CaptureMode=1, CaptureModeSoftware=0, ClockMode=0, CompareMode=4, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=50000, CONTROL3=0, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=0, InterruptOnCapture=true, InterruptOnCompare=false, InterruptOnOverUnderFlow=true, InterruptOnTC=false, Period=65535, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, ReloadOnCapture=true, ReloadOnCompare=false, ReloadOnOverUnder=true, ReloadOnReset=true, Resolution=16, RunMode=0, UDB16=true, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=true, UseInterrupt=true, VerilogSectionReplacementString=sC16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=Counter_v3_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Counter_Hall, CY_INSTANCE_SHORT_NAME=Counter_Hall, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 SP2, INSTANCE_NAME=Counter_Hall, )
...
module ADC_DelSig_v3_20_6 (
	...
	cy_clock_v1_0
		#(.id("6066588f-cc0f-41bd-bd6e-37cecb994b84/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("6066588f-cc0f-41bd-bd6e-37cecb994b84/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("7812500000"),
		  .is_direct(0),
...
module top ;
	...
	wire [0:0] tmpOE__Pin_TC_net;
	wire [0:0] tmpFB_0__Pin_TC_net;
	wire [0:0] tmpIO_0__Pin_TC_net;
	wire [0:0] tmpINTERRUPT_0__Pin_TC_net;
	electrical [0:0] tmpSIOVREF__Pin_TC_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("61113f09-76c0-40c1-927c-84713e6f711b"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_TC
		 (.oe(tmpOE__Pin_TC_net),
		  .y({Net_4774}),
		  .fb({tmpFB_0__Pin_TC_net[0:0]}),
		  .io({tmpIO_0__Pin_TC_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_TC_net),
		  .interrupt({tmpINTERRUPT_0__Pin_TC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_TC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PWM_C_L_net;
	wire [0:0] tmpFB_0__PWM_C_L_net;
	wire [0:0] tmpIO_0__PWM_C_L_net;
	wire [0:0] tmpINTERRUPT_0__PWM_C_L_net;
	electrical [0:0] tmpSIOVREF__PWM_C_L_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("c47e1fc8-854f-40f9-8362-54506a5b6da9"),
		  ...
		  .input_buffer_sel(2'b00))
		PWM_C_L
		 (.oe(tmpOE__PWM_C_L_net),
		  .y({Net_4775}),
		  .fb({tmpFB_0__PWM_C_L_net[0:0]}),
		  .io({tmpIO_0__PWM_C_L_net[0:0]}),
		  .siovref(tmpSIOVREF__PWM_C_L_net),
		  .interrupt({tmpINTERRUPT_0__PWM_C_L_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWM_C_L_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PWM_C_U_net;
	wire [0:0] tmpFB_0__PWM_C_U_net;
	wire [0:0] tmpIO_0__PWM_C_U_net;
	wire [0:0] tmpINTERRUPT_0__PWM_C_U_net;
	electrical [0:0] tmpSIOVREF__PWM_C_U_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("1e1eba94-30fc-4212-a1c9-fadc3c862f77"),
		  ...
		  .input_buffer_sel(2'b00))
		PWM_C_U
		 (.oe(tmpOE__PWM_C_U_net),
		  .y({Net_4776}),
		  .fb({tmpFB_0__PWM_C_U_net[0:0]}),
		  .io({tmpIO_0__PWM_C_U_net[0:0]}),
		  .siovref(tmpSIOVREF__PWM_C_U_net),
		  .interrupt({tmpINTERRUPT_0__PWM_C_U_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWM_C_U_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    PWM_v3_30_1 PWM_C (
        ...
        .ph1(Net_4776),
        .ph2(Net_4775));
    defparam PWM_C.Resolution = 16;

    CyControlReg_v1_80 Control_Reg_PWM_Reset (
        .control_1(Net_4753),
        .control_2(Net_4754),
        .control_3(Net_4755),
        .control_0(Net_3854),
        ...
        .clock(Net_1776),
        .reset(1'b0));
    defparam Control_Reg_PWM_Reset.Bit0Mode = 1;
    defparam Control_Reg_PWM_Reset.Bit1Mode = 0;
    defparam Control_Reg_PWM_Reset.Bit2Mode = 0;
    defparam Control_Reg_PWM_Reset.Bit3Mode = 0;
    defparam Control_Reg_PWM_Reset.Bit4Mode = 0;
    defparam Control_Reg_PWM_Reset.Bit5Mode = 0;
    defparam Control_Reg_PWM_Reset.Bit6Mode = 0;
    defparam Control_Reg_PWM_Reset.Bit7Mode = 0;
    defparam Control_Reg_PWM_Reset.BitValue = 1;
    defparam Control_Reg_PWM_Reset.BusDisplay = 0;
    defparam Control_Reg_PWM_Reset.ExtrReset = 1;
    defparam Control_Reg_PWM_Reset.NumOutputs = 1;

	wire [0:0] tmpOE__PWM_B_L_net;
	wire [0:0] tmpFB_0__PWM_B_L_net;
	wire [0:0] tmpIO_0__PWM_B_L_net;
	wire [0:0] tmpINTERRUPT_0__PWM_B_L_net;
	electrical [0:0] tmpSIOVREF__PWM_B_L_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("47f35db5-fa81-4a46-8abf-67fc6ff31a57"),
		  ...
		  .input_buffer_sel(2'b00))
		PWM_B_L
		 (.oe(tmpOE__PWM_B_L_net),
		  .y({Net_4787}),
		  .fb({tmpFB_0__PWM_B_L_net[0:0]}),
		  .io({tmpIO_0__PWM_B_L_net[0:0]}),
		  .siovref(tmpSIOVREF__PWM_B_L_net),
		  .interrupt({tmpINTERRUPT_0__PWM_B_L_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWM_B_L_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PWM_B_U_net;
	wire [0:0] tmpFB_0__PWM_B_U_net;
	wire [0:0] tmpIO_0__PWM_B_U_net;
	wire [0:0] tmpINTERRUPT_0__PWM_B_U_net;
	electrical [0:0] tmpSIOVREF__PWM_B_U_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("b1c5ea3b-5d27-4b44-9407-330084671915"),
		  ...
		  .input_buffer_sel(2'b00))
		PWM_B_U
		 (.oe(tmpOE__PWM_B_U_net),
		  .y({Net_4788}),
		  .fb({tmpFB_0__PWM_B_U_net[0:0]}),
		  .io({tmpIO_0__PWM_B_U_net[0:0]}),
		  .siovref(tmpSIOVREF__PWM_B_U_net),
		  .interrupt({tmpINTERRUPT_0__PWM_B_U_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWM_B_U_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    PWM_v3_30_2 PWM_B (
        ...
        .ph1(Net_4788),
        .ph2(Net_4787));
    defparam PWM_B.Resolution = 16;

	wire [0:0] tmpOE__PWM_A_L_net;
	wire [0:0] tmpFB_0__PWM_A_L_net;
	wire [0:0] tmpIO_0__PWM_A_L_net;
	wire [0:0] tmpINTERRUPT_0__PWM_A_L_net;
	electrical [0:0] tmpSIOVREF__PWM_A_L_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("5be9dc68-2a73-4e3d-8f47-b02f05255009"),
		  ...
		  .input_buffer_sel(2'b00))
		PWM_A_L
		 (.oe(tmpOE__PWM_A_L_net),
		  .y({Net_4799}),
		  .fb({tmpFB_0__PWM_A_L_net[0:0]}),
		  .io({tmpIO_0__PWM_A_L_net[0:0]}),
		  .siovref(tmpSIOVREF__PWM_A_L_net),
		  .interrupt({tmpINTERRUPT_0__PWM_A_L_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWM_A_L_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PWM_A_U_net;
	wire [0:0] tmpFB_0__PWM_A_U_net;
	wire [0:0] tmpIO_0__PWM_A_U_net;
	wire [0:0] tmpINTERRUPT_0__PWM_A_U_net;
	electrical [0:0] tmpSIOVREF__PWM_A_U_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		PWM_A_U
		 (.oe(tmpOE__PWM_A_U_net),
		  .y({Net_4800}),
		  .fb({tmpFB_0__PWM_A_U_net[0:0]}),
		  .io({tmpIO_0__PWM_A_U_net[0:0]}),
		  .siovref(tmpSIOVREF__PWM_A_U_net),
		  .interrupt({tmpINTERRUPT_0__PWM_A_U_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	cy_clock_v1_0
		#(.id("f4e6897e-7933-45a9-890c-3970b0900d2f"),
		  .source_clock_id("864cf3f7-dfc4-4027-8b51-bd1cade8edc8"),
		  .divisor(0),
		  .period("0"),
		  .is_direct(1),
		  .is_digital(1))
	...
	wire [0:0] tmpIO_0__Pin_Hall_2_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Hall_2_net;
	electrical [0:0] tmpSIOVREF__Pin_Hall_2_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("b37fdcce-0681-4f1f-942e-08eb187a21f2"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Hall_2
		 (.oe(tmpOE__Pin_Hall_2_net),
		  .y({1'b0}),
		  .fb({Net_6040}),
		  .io({tmpIO_0__Pin_Hall_2_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Hall_2_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Hall_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Hall_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_Hall_1_net;
	wire [0:0] tmpIO_0__Pin_Hall_1_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Hall_1_net;
	electrical [0:0] tmpSIOVREF__Pin_Hall_1_net;
	...
	assign tmpOE__Pin_Hall_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_Hall_0_net;
	wire [0:0] tmpIO_0__Pin_Hall_0_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Hall_0_net;
	electrical [0:0] tmpSIOVREF__Pin_Hall_0_net;
	...
	assign tmpOE__Pin_Hall_0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("3910a8b4-3e55-4342-88c3-14df48113bbb"),
		  .source_clock_id("864cf3f7-dfc4-4027-8b51-bd1cade8edc8"),
		  .divisor(0),
		  .period("0"),
		  .is_direct(1),
    ...
    CyStatusReg_v1_90 Status_Reg_Hall (
        ...
        .intr(Net_4594),
        .status_bus(8'b0));
    defparam Status_Reg_Hall.Bit0Mode = 0;
    defparam Status_Reg_Hall.Bit1Mode = 0;
    defparam Status_Reg_Hall.Bit2Mode = 0;
    defparam Status_Reg_Hall.Bit3Mode = 0;
    defparam Status_Reg_Hall.Bit4Mode = 0;
    defparam Status_Reg_Hall.Bit5Mode = 0;
    defparam Status_Reg_Hall.Bit6Mode = 0;
    defparam Status_Reg_Hall.Bit7Mode = 0;
    defparam Status_Reg_Hall.BusDisplay = 0;
    defparam Status_Reg_Hall.Interrupt = 0;
    defparam Status_Reg_Hall.MaskValue = 7;
    defparam Status_Reg_Hall.NumInputs = 3;
    ...
    defparam Counter_Hall.CompareStatusEdgeSense = 1;
    defparam Counter_Hall.EnableMode = 0;
    defparam Counter_Hall.ReloadOnCapture = 1;
    defparam Counter_Hall.ReloadOnCompare = 0;
    defparam Counter_Hall.ReloadOnOverUnder = 1;
    defparam Counter_Hall.ReloadOnReset = 1;
    defparam Counter_Hall.Resolution = 16;
    defparam Counter_Hall.RunMode = 0;
    ...
    Counter_v3_0_5 Counter_16 (
        ...
        .up_ndown(1'b1),
        .count(1'b0));
    defparam Counter_16.CaptureMode = 0;
    defparam Counter_16.ClockMode = 3;
    defparam Counter_16.CompareMode = 1;
    defparam Counter_16.CompareStatusEdgeSense = 1;
    defparam Counter_16.EnableMode = 0;
    defparam Counter_16.ReloadOnCapture = 0;
    defparam Counter_16.ReloadOnCompare = 0;
    defparam Counter_16.ReloadOnOverUnder = 1;
    defparam Counter_16.ReloadOnReset = 1;
	...
	wire [0:0] tmpOE__Pin_VBAT_net;
	wire [0:0] tmpFB_0__Pin_VBAT_net;
	wire [0:0] tmpIO_0__Pin_VBAT_net;
	wire [0:0] tmpINTERRUPT_0__Pin_VBAT_net;
	electrical [0:0] tmpSIOVREF__Pin_VBAT_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_VBAT
		 (.oe(tmpOE__Pin_VBAT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_VBAT_net[0:0]}),
		  .analog({Net_6508}),
		  .io({tmpIO_0__Pin_VBAT_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_VBAT_net),
		  .interrupt({tmpINTERRUPT_0__Pin_VBAT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_VBAT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
