...
void PWM_A_Stop(void) 
{
    ...
    *******************************************************************************/
    ...
    {
        CY_SET_REG16(PWM_A_COUNTER_LSB_PTR, counter);
    }
    ...
    *******************************************************************************/
    uint16 PWM_A_ReadCounter(void) 
    {
        ...
        return (CY_GET_REG16(PWM_A_CAPTURE_LSB_PTR));
    }
...
void PWM_A_WritePeriod(uint16 period) 
{
    ...
    #else
        CY_SET_REG16(PWM_A_PERIOD_LSB_PTR, period);
    #endif /* (PWM_A_UsingFixedFunction) */
}
    ...
    *******************************************************************************/
                                       ...
                                       
    {
        ...
        #else
            CY_SET_REG16(PWM_A_COMPARE1_LSB_PTR, compare);
        #endif /* (PWM_A_UsingFixedFunction) */
            ...
            #else
                CY_SET_REG16(PWM_A_COMPARE2_LSB_PTR, (compare + 1u));
            #endif /* (PWM_A_UsingFixedFunction) */
    ...
    *******************************************************************************/
    ...
    {
        #if(PWM_A_UsingFixedFunction)
            return ((uint16)CY_GET_REG16(PWM_A_COMPARE1_LSB_PTR));
        #else
            return (CY_GET_REG16(PWM_A_COMPARE1_LSB_PTR));
        #endif /* (PWM_A_UsingFixedFunction) */
    }
    ...
    *******************************************************************************/
    ...
    {
        return (CY_GET_REG16(PWM_A_COMPARE2_LSB_PTR));
    }
...
{
    #if(PWM_A_UsingFixedFunction)
        return ((uint16)CY_GET_REG16(PWM_A_PERIOD_LSB_PTR));
    #else
        return (CY_GET_REG16(PWM_A_PERIOD_LSB_PTR));
    #endif /* (PWM_A_UsingFixedFunction) */
}
